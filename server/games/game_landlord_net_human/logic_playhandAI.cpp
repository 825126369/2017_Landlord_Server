...
game_landlord_net_human_protocol::card_Info logic_playhandAI::get_rob_playhand(logic_player* player)
{
	game_landlord_net_human_protocol::card_Info result_cards;
