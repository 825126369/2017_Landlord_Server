...
world_peer_manager::~world_peer_manager()
{
...
void world_peer_manager::heartbeat( double elapsed )
{
	__ENTER_FUNCTION
...
void world_peer_manager::exec_event()
{
...
bool world_peer_manager::add_obj(int obj_id, boost::shared_ptr<world_peer> obj)
{
